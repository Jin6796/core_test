...
/**
 * @Class Name : ProjectMngtServiceImpl.java
 * @Description : ProjectMngtService Implement Class
...
@Repository
public class ProjectMngtServiceImpl implements ProjectMngtService	 {

	private static final Logger LOGGER = LoggerFactory.getLogger(ProjectMngtServiceImpl.class);
