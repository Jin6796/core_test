...
//		sqlLog("updateUserLastLogin", map);
	...
	public List<Map<String, Object>> BoardTestSBdaySelect(Map<String, Object> map) {
		return SqlSession.selectList("wai.com.service.impl.userMngtMapper.BoardTestSBdaySelect", map);
	}
	
	/** 월별 게시글 조회 */
	public List<Map<String, Object>> BoardTestSBmonth(Map<String, Object> map) {
		return SqlSession.selectList("wai.com.service.impl.userMngtMapper.BoardTestSBmonth", map);
	}
	
	/** 월별 작성자 게시글 합계 */
	public List<Map<String, Object>> BoardTestSBmonthSelect(Map<String, Object> map) {
		return SqlSession.selectList("wai.com.service.impl.userMngtMapper.BoardTestSBmonthSelect", map);
	}
	
	/** 월별 게시글 수 조회 */
	public List<Map<String, Object>> BoardTestSBmonthCNT(Map<String, Object> map) {
		return SqlSession.selectList("wai.com.service.impl.userMngtMapper.BoardTestSBmonthCNT", map);
	}
