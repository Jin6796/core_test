...
public class UserMngtServiceImpl implements UserMngtService	 {
	...
	/** 일별 작성자 게시글 합계 */
	@Override
	public List<Map<String, Object>> BoardTestSBdaySelect(Map<String, Object> map) throws Exception {
		return userMngtDAO.BoardTestSBdaySelect(map);
	}
	
	/** 월별 게시글 조회 */
	@Override
	public List<Map<String, Object>> BoardTestSBmonth(Map<String, Object> map) throws Exception {
		return userMngtDAO.BoardTestSBmonth(map);
	}
	
	/** 월별 작성자 게시글 합계 */
	@Override
	public List<Map<String, Object>> BoardTestSBmonthSelect(Map<String, Object> map) throws Exception {
		return userMngtDAO.BoardTestSBmonthSelect(map);
	}

	/** 월별 게시글 수 조회 */
	@Override
	public List<Map<String, Object>> BoardTestSBmonthCNT(Map<String, Object> map) throws Exception {
		return userMngtDAO.BoardTestSBmonthCNT(map);
	}
